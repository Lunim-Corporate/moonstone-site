...
export interface PitchDeckAccessEmailProps {
  fullName: string;
  email: string;
  nickName?: string;
  accessReason?: string;
...
export const PitchDeckAccessEmail = ({
  fullName,
  email,
  nickName,
  accessReason,
  submittedAt,
}: PitchDeckAccessEmailProps) => (
  <div
    style={{
  ...
  >
    ...
    >
      ...
      <p style={{ margin: "0 0 24px", lineHeight: 1.6 }}>
        {fullName} has created an account to access the pitch deck. Details are below.
      </p>
...
PitchDeckAccessEmail.displayName = "PitchDeckAccessEmail";
